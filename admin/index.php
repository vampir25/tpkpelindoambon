<?php 
 ...
 ?>
  ...
  <html>
    <head>
    	<title>Pengaduan Masalah Pelindo</title>
    ...
    <body style="background:url(../img/bck2.jpg); background-size: cover;">
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#user"><img class="circle" src="https://cdn.vectorstock.com/i/1000v/66/34/halloween-scarecrow-pumpkin-head-jack-o-lantern-vector-43696634.avif"></a>
              ...
              <li><a href="index.php?p=registrasi"><i class="material-icons">featured_play_list</i>Daftar Pegawai</a></li>
              <li><a href="index.php?p=pengaduan"><i class="material-icons">report</i>Laporkan Masalah</a></li>
              <li><a href="index.php?p=respon"><i class="material-icons">question_answer</i>Tanggapan</a></li>
	...
	<?php 
		...
		elseif(@$_GET['p']=="regis_hapus"){
			$query = mysqli_query($koneksi,"DELETE FROM masyarakat WHERE nipp='".$_GET['nik']."'");
			if($query){

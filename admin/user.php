	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn teal modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>">Edit</a> <a class="red btn" onclick="return confirm('Anda Yakin Ingin Menghapus ')" href="index.php?p=user_hapus&id_petugas=<?php echo $r['id_petugas'] ?>">Hapus</a></td>
          ...
          <div class="modal-content">
			...
			<form method="POST">
				...
				<div class="col s12 input-field">
					...
					<input id="telp" type="text" name="telp"><br><br>
				</div>

				<div class="col s12 input-field">
					<select class="default" name="level">
						<option selected disabled="">Tambah Sebagai</option>
